...
mod.on_setting_changed = function(setting_id)
    ...
    mod:echo("attack_ragdolls_enabled before: %s", tostring(attack_ragdolls_enabled))
    Application.set_user_setting("gore_settings", "attack_ragdolls_enabled", mod:get(SettingNames.RagdollInteraction))
    mod:echo("attack_ragdolls_enabled after: %s", tostring(Application.user_setting("gore_settings", "attack_ragdolls_enabled")))
end
